 ...
 * Output:      addr: The pointer of the LM2M_Address_T.
 ...
 * Input:        socketId: The socket id.
 *                  addr_in:  The pointer of LM2M_Address_T
 ...
 * Input:        socketId: The socket id.
 *                  addr:  The pointer of LM2M_Address_T
